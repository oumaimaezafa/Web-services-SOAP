 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://enset.ma/", wsdlLocation = "http://localhost:9090/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://enset.ma/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://enset.ma/", "BankServicePort"), BankService.class, features);
    }
